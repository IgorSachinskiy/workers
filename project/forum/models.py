...
class Post(models.Model):
    ...
    registered_by = models.ForeignKey(UserModel, on_delete=models.CASCADE, verbose_name='Автор')
    registered_in = models.DateTimeField('Создано', auto_now_add=True)
...
class Reply(models.Model):
    """Отклики на запись"""
    post = models.ForeignKey(Post, on_delete=models.CASCADE, verbose_name='Отклик')
    text = models.TextField('Сообщение')
    registered_by = models.ForeignKey(UserModel, on_delete=models.CASCADE, verbose_name='Автор')
    registered_in = models.DateTimeField('Создано', auto_now_add=True)
